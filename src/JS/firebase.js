...
function markupUserAuth({ displayName, email, photoURL }) {
  googleAuthDiv.insertAdjacentHTML(
   ...
   <div class="">
      <button type="button" id="google" class="google-btn--logout"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="logout-svg" viewBox="0 0 16 16">
